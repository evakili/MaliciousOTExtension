...
#define NumberModMul(res, a, b, params) res = modmult(((const Big) a), ((const Big) b), ((const Big) (*params.eccparams.order)))
#define NumberMod(res, params) res%=(*params.eccparams.order)
...
#define NumberToByte(buf, bytelen, ele)  big_to_bytes (bytelen, (ele).getbig(), (char*) buf, true) //prepend leading zeros
